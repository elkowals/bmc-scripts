...
#MSB to LSB
if len(sys.argv) < 2:
	print("missing slot parameters to be enabled")
	print("example:")
	print("ENABLE_RSVD_SLOTS.py 0,1,2,3")
	print("ENABLE_RSVD_SLOTS.py none")
	print("none = all reserved bits are disabled")
elif sys.argv[1] == "none":
	print("setting all reserved bits slots disabled")
	reg6_i2c4.reverse()
	reg7_i2c4.reverse()
	reg6_i2c9.reverse()
	reg7_i2c9.reverse()
